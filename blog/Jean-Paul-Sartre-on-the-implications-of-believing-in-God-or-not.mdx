...
> If one considers an article of manufacture as, for example, a paper-knife - one sees that it has been made by a designer to serve a definite purpose. no one would produce a paper-knife without knowing what it was for. \
>
